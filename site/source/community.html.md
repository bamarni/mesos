...
<div class="row-fluid">
  <div class="col-md-6">
    ...
    <p>Mesos relies on its community to test releases, find bugs, contribute new features, and provide feedback on existing APIs. Your contributions are greatly appreciated! Since the infrastructure that the Mesos community uses day-to-day (ReviewBoard and JIRA) is unfamiliar to some, we also provide a newbie guide which will help you get started using only GitHub.</p>
    <p>Is this your first time contributing? See our <a href="/documentation/latest/newbie-guide">newbie guide</a>. Thanks! We love patches. :)</p>
